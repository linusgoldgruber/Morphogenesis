...
#define VM1_(state)           state.s[(state.i+M1WELL) & 0x0000000fU]
#define VM2_(state)           state.s[(state.i+M2WELL) & 0x0000000fU]
#define VM3_(state)           state.s[(state.i+M3WELL) & 0x0000000fU]
...
#define VM1           state->s[(state->i+M1WELL) & 0x0000000fU]
#define VM2           state->s[(state->i+M2WELL) & 0x0000000fU]
#define VM3           state->s[(state->i+M3WELL) & 0x0000000fU]
